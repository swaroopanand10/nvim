...
_G.packer_plugins = {
  ...
  monovibrantdark = {
    loaded = true,
    path = "/home/swaroop/.local/share/nvim/site/pack/packer/start/monovibrantdark",
    url = "https://github.com/swaroopanand10/monovibrantdark"
  },
  ["nlsp-settings.nvim"] = {
    loaded = true,
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/home/swaroop/.local/share/nvim/site/pack/packer/start/vim-surround",
