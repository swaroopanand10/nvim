...
vim.cmd [[autocmd filetype cpp nnoremap <F9> :w <bar> !g++ -std=c++17 -O2 % -o %:p:h/a.out && %:p:h/a.out<Enter><CR>]]
vim.cmd [[nnoremap <C-c> :!g++ -o %:p:h/a.out % -std=c++17<Enter>]]
vim.cmd [[nnoremap <C-x> :!%:p:h/a.out<Enter>]]
